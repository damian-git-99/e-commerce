...
export const productDetailsReducer = (
  ...
  switch (action.type) {
    case PRODUCT_DETAILS_TYPES.PRODUCT_DETAILS_REQUEST:
      return { loading: true, ...state };
    case PRODUCT_DETAILS_TYPES.PRODUCT_DETAILS_SUCCESS:
      return { loading: false, product: action.payload };
    case PRODUCT_DETAILS_TYPES.PRODUCT_DETAILS_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
...
export const productDeleteReducer = (state = {}, action) => {
  switch (action.type) {
    case PRODUCT_DELETE_TYPES.PRODUCT_DELETE_REQUEST:
      return { loading: true };
    case PRODUCT_DELETE_TYPES.PRODUCT_DELETE_SUCCESS:
...
export const productUpdateReducer = (state = { product: {} }, action) => {
  switch (action.type) {
    case PRODUCT_UPDATE_TYPES.PRODUCT_UPDATE_REQUEST:
      return { loading: true };
    case PRODUCT_UPDATE_TYPES.PRODUCT_UPDATE_SUCCESS:
      return { loading: false, success: true, product: action.payload };
    case PRODUCT_UPDATE_TYPES.PRODUCT_UPDATE_FAIL:
      return { loading: false, error: action.payload };
    case PRODUCT_UPDATE_TYPES.PRODUCT_UPDATE_RESET:
      return { product: {} };
    default:
      return state;
  }
...
export const productReviewCreateReducer = (state = {}, action) => {
  switch (action.type) {
    case PRODUCT_CREATE_REVIEW.PRODUCT_CREATE_REVIEW_REQUEST:
      return { loading: true };
    case PRODUCT_CREATE_REVIEW.PRODUCT_CREATE_REVIEW_SUCCESS:
      return { loading: false, success: true };
    case PRODUCT_CREATE_REVIEW.PRODUCT_CREATE_REVIEW_FAIL:
      return { loading: false, error: action.payload };
    case PRODUCT_CREATE_REVIEW.PRODUCT_CREATE_REVIEW_RESET:
      return {};
    default:
      return state;
  }
...
export const PRODUCT_DETAILS_TYPES = {
...
export const PRODUCT_DELETE_TYPES = {
